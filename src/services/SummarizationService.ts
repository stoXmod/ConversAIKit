...
export class SummarizationService {
    ...
    public async summarize(document: string, inquiry: string, onSummaryDone: Function) {
    ...
    public async summarizeLongDocument(document: string, inquiry: string, onSummaryDone: Function): Promise<string> {
